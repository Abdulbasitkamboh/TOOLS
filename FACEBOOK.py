...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" ABDUL BASIT  [Abdulbasitkamboh]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" 100055162805912"$i"                   |"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"ABDUL BASIT"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 1
git clone https://github.com/Abdulbasitkamboh/TOOLS
cd fbbrute
php fb.php
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Abdulbasitkamboh/Fb-TOOLS-v.3
cd Fb-TOOLS-v.3
python2 TOOLS.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Abdulbasitkamboh/fb-TOOLA
cd fb-brute
python2 TOOLS.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Abdulbasitkamboh/TOOLS.git
cd TOOLS
bash TOOLS.sh
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Absulbasitkamboh/TOOLS
cd TOOLS
unzip TOOLS.zip
python2 TOOLS.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
https://github.com/Abdulbasitkamboh/TOOLS.git
chmod +x *
python2 TOOLS.py
fi
...
install git && pip2 install mechanize && pkg install curl && pkg install ruby && pkg install gem && gem install lolcat && pkg install git && pkg install php && pkg install ruby cowsay toilet figlet
...
sleep 2
echo $ku"Facebook :"$i" 100055162805912"
sleep 2
echo $pur">> Thanks For Your Visit My <<"
exit
fi
